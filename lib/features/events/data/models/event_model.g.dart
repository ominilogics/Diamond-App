...
void _eventModelSerialize(
  ...
  writer.writeString(offsets[2], object.reminder);
...
EventModel _eventModelDeserialize(
  ...
  object.reminder = reader.readString(offsets[2]);
...
extension EventModelQueryFilter
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> isCustomEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isCustom',
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> reminderEqualTo(
    String value, {
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> reminderLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> reminderBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> reminderEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> reminderContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> reminderMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension EventModelQuerySortBy
  ...
  QueryBuilder<EventModel, EventModel, QAfterSortBy> sortByIsCustom() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCustom', Sort.asc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> sortByIsCustomDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCustom', Sort.desc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> sortByReminder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'reminder', Sort.asc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> sortByReminderDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension EventModelQuerySortThenBy
  ...
  QueryBuilder<EventModel, EventModel, QAfterSortBy> thenByIsCustom() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCustom', Sort.asc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> thenByIsCustomDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCustom', Sort.desc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> thenByReminder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'reminder', Sort.asc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> thenByReminderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'reminder', Sort.desc);
    });
  }
...
extension EventModelQueryWhereDistinct
  ...
  QueryBuilder<EventModel, EventModel, QDistinct> distinctByIsCustom() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isCustom');
    });
  }

  QueryBuilder<EventModel, EventModel, QDistinct> distinctByReminder(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension EventModelQueryProperty
  ...
  QueryBuilder<EventModel, bool, QQueryOperations> isCustomProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isCustom');
    });
  }

  QueryBuilder<EventModel, String, QQueryOperations> reminderProperty() {
    return QueryBuilder.apply(this, (query) {
