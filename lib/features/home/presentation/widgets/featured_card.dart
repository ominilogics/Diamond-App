              ...
              Positioned(
                ...
                child: onDelete != null
                    ? GestureDetector(
                        ...
                        child: Padding(
                          padding: EdgeInsets.only(top: 14.h, right: 14.w, left: 14.w, bottom: 14.h),
                          child: Icon(Icons.delete_outline, color: Colors.red, size: 23.w),
                        ),
                      )
                    : Consumer(
                        builder: (context, ref, child) {
                          final isFavoriteAsync = ref.watch(
                            isFavoriteProvider(cardId),
                          );
